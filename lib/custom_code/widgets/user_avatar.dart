...
import 'package:visu_a_i_customer_1/app_state.dart';
...
class _UserAvatarState extends State<UserAvatar> {
  ...
  void loadImage(String? avatar) {
    Uint8List imageBytes;
    if (avatar != null && avatar.isNotEmpty) {
      imageBytes = base64Decode(avatar);
    } else {
      // Properly decode the base64 default avatar
      imageBytes = base64Decode(defaultAvatar);
    }
    setState(() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        image: DecorationImage(
          image: imageProvider ?? MemoryImage(base64Decode(defaultAvatar)),
          fit: BoxFit.cover,
        ),
      ),
    );
