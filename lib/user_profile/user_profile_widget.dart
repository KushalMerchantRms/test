                                          ...
                                          children: [
                                            Text(
                                              valueOrDefault<String>(
                                                '${APIsAllGroup.userProfileCall.firstName(
                                                  columnUserProfileResponse
                                                      .jsonBody,
                                                )} ${APIsAllGroup.userProfileCall.lastName(
                                                  columnUserProfileResponse
                                                      .jsonBody,
                                                )}',
                                                'NA',
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Text(
                                                      valueOrDefault<String>(
                                                        '${FFAppState().userMobileNumber != '' ? FFAppState().finalCountryCode : ''} ${FFAppState().userMobileNumber}',
                                                        'NA',
                                                      ),
                                                      style: FlutterFlowTheme
                                                              .of(context)
