...
import 'edit_bottom_sheet_alert_model.dart';
export 'edit_bottom_sheet_alert_model.dart';

class EditBottomSheetAlertWidget extends StatefulWidget {
  const EditBottomSheetAlertWidget({
    super.key,
    this.commets,
    this.id,
    this.action,
  ...
  @override
  State<EditBottomSheetAlertWidget> createState() =>
      _EditBottomSheetAlertWidgetState();
}

class _EditBottomSheetAlertWidgetState extends State<EditBottomSheetAlertWidget>
    with TickerProviderStateMixin {
  late EditBottomSheetAlertModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditBottomSheetAlertModel());
