...
class _IncidentDetailsWidgetState extends State<IncidentDetailsWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      FFAppState().InProgrecDetails = true;
      safeSetState(() {});
      ...
      await Future.wait([
        Future(() async {
          _model.apiResultnuu4 = await APIsAllGroup.getAvatarCall.call(
            authToken: FFAppState().token,
          );

          if ((_model.apiResultnuu4?.succeeded ?? true)) {
            FFAppState().avatarURL =
                (_model.apiResultnuu4?.jsonBody ?? '').toList().cast<dynamic>();
            safeSetState(() {});
          }
        }),
        Future(() async {
          _model.incidentDetailsDataJson =
              await OtherAPIsGroup.incidentDetailsCall.call(
            authToken: FFAppState().token,
            incidentId: FFAppState().IncidentID != 0
                ? FFAppState().IncidentID
                : widget.inciID,
          );

          FFAppState().incidentDetails =
              (_model.incidentDetailsDataJson?.jsonBody ?? '');
          safeSetState(() {});
        }),
      ]);
      FFAppState().IncidentID = 0;
      FFAppState().isSet = false;
      FFAppState().InProgrecDetails = false;
      safeSetState(() {});
    });
      ...
      builder: (context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              if (FFAppState().IsNotification == true) {
                FFAppState().IsNotification = false;
                safeSetState(() {});

                context.goNamed(IncidentScreenWidget.routeName);
              } else {
                context.safePop();
              }
            },
        ...
        body: Builder(
          builder: (context) {
            if (!FFAppState().InProgrecDetails) {
              return Container(
                      ...
                      if (responsiveVisibility(
                        ...
                        Container(
                          ...
                          child: custom_widgets.PinchToZoomVideoPlayer(
                            ...
                            incidentTIme: valueOrDefault<String>(
                              getJsonField(
                                FFAppState().incidentDetails,
                                r'''$.incident_time''',
                              )?.toString(),
                              ...
                              children: [
                                ...
                                Align(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      _model.shortUrl4 = await APIsAllGroup
                                          .uRLShortenerCall
                                          .call(
                                        authToken: FFAppState().token,
                                        url:
                                            '/incidentDetails?inciID=${widget.inciID?.toString()}',
                                      );
                                                                                                        ...
                                                                                                        builder: (context) {
                                                                                                          return Padding(
                                                                                                            ...
                                                                                                            child: EditBottomSheetWidget(
                                                                                                              ...
                                                                                                              action: () async {
                                                                                                                _model.updatedAudit2 = await actions.updatejson(
                                                                                                                  getJsonField(
                                                                                                                    FFAppState().incidentDetails,
                                                                                                                    r'''$.audit[0]''',
                                                                                                                  ),
                                                                                                                ...
                                                                                                                _model.updateAuditListAtIndex(
                                                                                                                  0,
                                                                                                                  (_) => _model.updatedAudit2!,
                                                                                                                );
                                                                                                                safeSetState(() {});
                                                                                                                FFAppState().updateIncidentUrlAtIndex(
                                                                                                                  widget.index!,
                                                                                                                  (_) => functions.updatedMainJson(FFAppState().IncidentUrl.elementAtOrNull(widget.index!)!, _model.auditList.toList()),
                                                                                                                );
                                                                                                                FFAppState().update(() {});
                                                                                                              },
                                                                                                            ),
                                                            ...
                                                            return Container(
                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child:
                                                                  ...
                                                                  key: Key(
                                                                      'Key140_${auditIndex}_of_${audit.length}'),
                                                                  actionType:
                                                                      valueOrDefault<
                                                                          int>(
                                                                    getJsonField(
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            action:
                                                                                () async {
                                                                              _model.updatedAudit1 = await actions.updatejson(
                                                                                auditItem,
                                                                                FFAppState().newcomment,
                                                                                getCurrentTimestamp.toString(),
                                                                                valueOrDefault<String>(
                                                                              ...
                                                                              await actions.updateItem(
                                                                                ...
                                                                                _model.updatedAudit1!,
                                                                              );
                                                                              _model.updateAuditListAtIndex(
                                                                                auditIndex,
                                                                                (_) => _model.updatedAudit1!,
                                                                              );
                                                                              safeSetState(() {});
                                                                              FFAppState().updateIncidentUrlAtIndex(
                                                                                widget.index!,
