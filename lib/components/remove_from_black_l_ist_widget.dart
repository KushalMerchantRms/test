...
import '/components/black_list_remove_con_widget.dart';
...
import 'remove_from_black_l_ist_model.dart';
export 'remove_from_black_l_ist_model.dart';

class RemoveFromBlackLIstWidget extends StatefulWidget {
  const RemoveFromBlackLIstWidget({
    super.key,
    required this.remove,
    this.action,
  });

  final IncidentDataStruct? remove;
  final Future Function()? action;

  @override
  State<RemoveFromBlackLIstWidget> createState() =>
      _RemoveFromBlackLIstWidgetState();
}

class _RemoveFromBlackLIstWidgetState extends State<RemoveFromBlackLIstWidget> {
  late RemoveFromBlackLIstModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RemoveFromBlackLIstModel());
            ...
            child: Column(
              ...
              children: [
                Align(
                  ...
                  child: Text(
                    'Are you sure you want to remove from watchlist this user?',
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Align(
                                        ...
                                        child: Text(
                                          widget.remove?.incidentTime != null
                                              ? '${dateTimeFormat("d MMM yyyy", widget.remove?.incidentTime)}|${dateTimeFormat("jm", widget.remove?.incidentTime)}'
                      ...
                      if (responsiveVisibility(
                        ...
                        Container(
                          ...
                          child: custom_widgets.TimezoneCurrentTime(
                            width: 85.0,
                            height: 25.0,
                            timeZone: widget.remove?.blacklistedTime != null
                                ? '${functions.formatDateString(widget.remove?.blacklistedTime?.toString())} - ${dateTimeFormat("jm", widget.remove?.blacklistedTime)}'
                  ...
                  child: Padding(
                    ...
                    child: RichText(
                      ...
                      text: TextSpan(
                        children: [
                          TextSpan(
                            text: 'Reason for remove  from watchlisting ',
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  fontFamily: 'Inter',
                ...
                if (FFAppState().comment != '')
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(0.0, 30.0, 0.0, 0.0),
                    child: Text(
                      'We have remove watchlisted the user, and our review team will review the case and provide an update within 48 hours.',
                      textAlign: TextAlign.center,
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                            fontFamily: 'Inter',
                            color: Color(0xFF818181),
                              ...
                              await showDialog(
                                ...
                                builder: (dialogContext) {
                                  return Dialog(
                                    ...
                                    child: BlackListRemoveConWidget(
                                      commnet: _model.textController.text,
                                      inciId: widget.remove?.id,
                                      action: () async {
