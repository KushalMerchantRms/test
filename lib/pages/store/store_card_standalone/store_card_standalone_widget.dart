...
import 'store_card_standalone_model.dart';
export 'store_card_standalone_model.dart';

class StoreCardStandaloneWidget extends StatefulWidget {
  const StoreCardStandaloneWidget({
    super.key,
    String? placeName,
    String? placeAddress,
    ...
    int? cashActivities,
    int? suspeciousEvents,
  })  : this.placeName = placeName ?? 'Place',
        this.placeAddress = placeAddress ?? 'Address',
        this.noOfIncidents = noOfIncidents ?? 0,
        this.transactionEvents = transactionEvents ?? 0,
        this.cashActivities = cashActivities ?? 0,
        this.suspeciousEvents = suspeciousEvents ?? 0;

  final String placeName;
  final String placeAddress;
  final RiskStatus? riskStatus;
  final int noOfIncidents;
  final int transactionEvents;
  final int cashActivities;
  final int suspeciousEvents;

  @override
  State<StoreCardStandaloneWidget> createState() =>
      _StoreCardStandaloneWidgetState();
}

class _StoreCardStandaloneWidgetState extends State<StoreCardStandaloneWidget> {
  late StoreCardStandaloneModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StoreCardStandaloneModel());
              ...
              children: [
                ...
                wrapWithModel(
                  ...
                  child: IncidentsBadgeWidget(
                    incidentsNumber: widget.noOfIncidents,
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      wrapWithModel(
                        ...
                        child: SingleStatCardWidget(
                          title: 'Suspecious\nEvents',
                          number: widget.suspeciousEvents,
                        ),
                      ),
                    ],
                  ),
